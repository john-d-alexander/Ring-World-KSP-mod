...
namespace NivenRingworld
{
    internal static class TerrainTint
    {
        ...
        internal static Color WithCanopy(TerrainSample ground,BiomeAppearance appearance)
        {return UnityEngine.Color.Lerp(Color(ground),new Color((float)appearance.CanopyColor.X,(float)appearance.CanopyColor.Y,(float)appearance.CanopyColor.Z),(float)appearance.CanopyCover);}
